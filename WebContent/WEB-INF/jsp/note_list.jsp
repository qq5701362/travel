                                ...
                                <div class="pic">
                                    <div class="cover">
                                        <a
                                            ...
                                            class="scale-effect " src="pic/${travel.pic1}" onerror="this.src='images/moren.jpg'"/>"/></a>
                                    </div>
                                    <div class="head">
                                        <img src="pic/${travel.userimag}" onerror="this.src='images/moren.jpg'"/>
                                    </div>
                                </div>
                                <div class="meta">
                                    <p>
