...
<body>
                ...
                <div class="user">
                    ...
                    <div class="user-bd">
                        ...
                        <ul class="nav_sort"> 
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/travel/write_note">
                                    <i class="i2"></i>写游记
                                </a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/synopsis/ticketHistory?userid=${user.userid}">
                                    <i class="i2"></i>购票记录
                                </a>
                            </li>
    ...
    <div id="quick_nav">
        	<a href="${pageContext.request.contextPath}/synopsis/ticketHistory?userid=${user.userid}">
        		<span class="ico4"><img src="images/nav_ico4.png" /></span>购票记录
        	</a>
    </div>
</body>
</html>