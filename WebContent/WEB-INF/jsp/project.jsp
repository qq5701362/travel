        ...
        <div class="cw1200">
                    ...
                    <div class="preview">
                        ...
                        <div id="imageMenu">
                            <ul>
                                ...
                                <li><img src="pic/${specialty.pic2}" onerror="this.src='images/moren.jpg'"/></li>
            ...
            <!-- 表单提交 -->
                <form action="${pageContext.request.contextPath}/order/giveOrder" method="post">  
                            ...
                            <div id="ss"><input id="go_buy" style="margin-top:40px;" type="submit" value="购买"/>
                            </div>
                </form>
                <!-- 表单提交 -->
                                ...
                                <li>
                                    <div class="pic">
                                        <a title="" href="${pageContext.request.contextPath}/specialty/getSpecialty?tnum=${comment.tnum}&id=${comment.id}"><img alt="" class="scale-effect"
                                            src="pic/${comment.tpic}" onerror="this.src='images/moren.jpg'"/></a>
                                    </div>
                                    <div class="con">
