        ...
        <div class="replace_name">
            <form action="${pageContext.request.contextPath }/travel/updateTravel.action" method="post" enctype="multipart/form-data">
                ...
                <div id="div2" class="form-group">
                    <label for="inputfile"><img src="images/tip.jpg" onerror="this.src='images/moren.jpg'"/></label>
                    <div id="pic">
                                ...
                                <td>风景一：
                                    <div id="pic1">
                                        <c:if test="${travel.pic1!=null}">
                                            <img src="pic/${travel.pic1}" onerror="this.src='images/moren.jpg'"/>
                                        </c:if>
                                ...
                                <td>风景二：
                                    <div id="pic2">
                                        <c:if test="${travel.pic2!=null}">
                                            <img src="pic/${travel.pic2}" onerror="this.src='images/moren.jpg'"/>
                                        </c:if>
                                    </div>
                                </td>
                            </tr>
                                ...
                                <td>风景三：
                                    <div id="pic3">
                                        <c:if test="${travel.pic3!=null}">
                                            <img src="pic/${travel.pic3}" onerror="this.src='images/moren.jpg'"/>
                                        </c:if>
                                    </div>
                                </td>
                            </tr>
