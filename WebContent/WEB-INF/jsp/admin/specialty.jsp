                            ...
                            <tr>
                                ...
                                <td style="width: 250px;">
                                    <button type="button" class="btn btn-info" data-toggle="modal"
                                        data-target="#pSpecialty" name="publish">发布
                                    </button>
                                    <button type="button" class="btn btn-info" data-toggle="modal"
                                        data-target="#myModal" name="edit">修改
                                    </button> 
                                    <a href="${pageContext.request.contextPath}/backSpecialty/downSpecialty?id=${item.id}">
                                        <button type="button" class="btn btn-warning">下架</button>
                                    </a> 
                                    <a href="${pageContext.request.contextPath}/backSpecialty/upSpecialty?id=${item.id}">
    ...
    <script>
        ...
        $(function() {
          $("Button[name='publish']").each(function() {
              $(this).click(function() {
            	  //
                 var contentid = $(this).parent().parent().children().eq(0).text();
            	  //
                 var title = $(this).parent().parent().children().eq(1).text();
            	  //
                 var stage = $(this).parent().parent().children().eq(7).text();
            	  //
                 var pic = $(this).parent().parent().children().eq(8).text();
            	  //
                 var areanum = $(this).parent().parent().children().eq(12).text();
            	  //
                 var path = $(this).parent().parent().children().eq(14).text();
