            ...
            <c:forEach items="${userAllTravels}" var="travel" varStatus="id">
                <li class="pd_r150">
                    ...
                    <div class="con">
                        ...
                        <div class="user">
                            <span><img src="pic/${travel.userimag}" onerror="this.src='images/moren.jpg'"/>作者：<font>${travel.username}</font></span>
                            <label><img src="images/state_icon1.png" onerror="this.src='images/moren.jpg'"/>${travel.readnum}</label>
                        </div>
