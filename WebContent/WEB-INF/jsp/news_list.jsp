                ...
                <div id="news_list">
                    ...
                    <c:forEach items="${pageInfo.list}" var="information" varStatus="id">
                        <li>
                            ...
                            <div class="pic"><a href="${pageContext.request.contextPath}/information/getInformation?id=${information.id}"><img class="scale-effect" src="pic/${information.pic}" onerror="this.src='images/moren.jpg'"/></a></div>
                            <div class="con">
