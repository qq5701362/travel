                ...
                <div class="public_box bg1">
                    ...
                    <div id="scenic_list">
                        ...
                        <c:forEach items="${pageInfo.list}" var="sc">  
                             <li>
                                <div class="pic">
                                    <a href="${pageContext.request.contextPath}/scenic/getScenic?id=${sc.scenicid}&scenicnum=${sc.scenicnum}"><img class="scale-effect" src="pic/${sc.pic1}" onerror="this.src='images/moren.jpg'"/></a>
                                </div>
                                <div class="con">
                                    <h3>
